...
load("..\..\data\LoRa_trilateration_test_3\Rx_green.mat");
Rx_green = filtered_data;

load("..\..\data\LoRa_trilateration_test_3\Rx_yellow.mat");
Rx_yellow = filtered_data;

load("..\..\data\LoRa_trilateration_test_3\Rx_green_distance.mat");
Rx_green_distance = filtered_data;

load("..\..\data\LoRa_trilateration_test_3\Rx_yellow_distance.mat");
Rx_yellow_distance = filtered_data;
